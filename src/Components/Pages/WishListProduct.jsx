...
function WishlistProduct() {
  ...
  const NextArrow = ({ onClick }) => (
    <div
      className={`WishPdtArrow WishPdtNext ${isLastSlide ? "iconHidden" : ""}`}
      onClick={onClick}
    >
      <IoIosArrowForward />
    </div>
  ...
  const PrevArrow = ({ onClick }) => (
    <div
      className={`WishPdtArrow WishPdtPrev ${isFirstSlide ? "iconHidden" : ""}`}
      onClick={onClick}
    >
      <IoIosArrowBack />
    </div>
  ...
  return (
    <div className="container-fluid wishListBg my-xl-4 my-lg-4  my-2 ">
      <div className="row">
        <div className="col-12  d-flex justify-content-between my-2">
          <div className="">
            <h1 className="wishlistpdth1">
              Products From Your Wishlist{" "}
              <span className="wishListSpan">(9 items)</span>
            </h1>
          </div>
          <div className="">
            <Link to="/products" className="proText">
              View All <IoIosArrowForward size={15} className="" />
            </Link>
          </div>
        </div>
      </div>
